...
//         try {
//             const {username,email,password,role,address,phoneNumber,aadharCard,electricBill}=await request.json()
...
//             await newUser.save()
//             console.log("Data if new user has now been saved");
...
//                 {
//                     success:true,
//                     message:"User registered successfully.Please verify your emai"
//                 },
//                 {status:200}
//             )
//         }
